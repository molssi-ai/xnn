...
(see :mod:`xnn.ffnn.models.oplslib`).
...
exclusions and 1,4 pairs follow (:mod:`xnn.ffnn.models.topology`). The
...
def _as_library(source: Union[OPLSLibrary, str, Path]) -> OPLSLibrary:
    ...
    source : OPLSLibrary, str or Path
        A parsed library, or anything :func:`~xnn.ffnn.models.oplslib.read_opls`
...
class OPLSForceField(nn.Module):
    ...
    library : OPLSLibrary, str or Path
        ...
        :func:`~xnn.ffnn.models.oplslib.read_opls`).
    ...
    def resolve_improper(self, *args) -> int:
        ...
        *args : str
            ...
            order (:func:`~xnn.ffnn.models.oplslib.resolve_improper_type`).
...
class OPLS(InteratomicPotential):
    ...
    ffield : OPLSLibrary, OPLSForceField, str or Path
        ...
        shipped with xnn (``"oplsaa"``, ``"oplsaa-1996"``, ``"lopls"``,
    ...
    def from_atoms(cls, structure, ffield: Union[OPLSLibrary, str, Path] = "oplsaa",
        ...
        atom types are assigned by :func:`~xnn.ffnn.common.typing.assign_atom_types`,
    ...
    def from_config(cls, cfg) -> "OPLS":
        ...
        with xnn such as ``oplsaa``, a ``.frc`` path or a native JSON path)
