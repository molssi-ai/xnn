...
(:func:`~xnn.common.config.coerce.coerce_per_species`) so the accepted
...
def dataset_structures(dataset) -> list[dict]:
    ...
    Works for both an :class:`~xnn.common.data.AtomicDataset` and a
...
def build_e0_lookup(atomic_energies: Any, species: Any = None,
    ...
    atomic_energies : Any
        ...
        these (parsed by
        :func:`~xnn.common.config.coerce.coerce_per_species`).
