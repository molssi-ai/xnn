...
(:meth:`xnn.dnn.models.ani.ANI.ani1ccx`) by transfer learning. Upstream ships
...
builder is a thin restriction of :class:`~xnn.common.data.hub.ani1x.ANI1xBuilder`
...
class ANI1ccxBuilder(ANI1xBuilder):
    ...
    :class:`~xnn.common.data.hub.ani1x.ANI1xBuilder`; this class only pins the
