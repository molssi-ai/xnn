...
* All parameters come from a standard ``ffield`` text library or a
  ReaxFF-nn JSON library (see :mod:`xnns.ffnn.models.ffield`); energies are
...
from xnns.common.models.ops import scatter_sum, build_triplets
...
class ReaxFF(InteratomicPotential):
    ...
    ffield : str or Path or FFieldLibrary
        ...
        :class:`~xnns.ffnn.models.ffield.FFieldLibrary`).
