...
class GNNPotential(InteratomicPotential):
    ...
    :class:`~xnns.gnn.models.cace.CACE` (Cartesian angular basis) subclasses
    it directly.
...
class EquivariantGNN(GNNPotential):
    ...
    :class:`~xnns.gnn.models.nequip.NequIP`, MACE and
    :class:`~xnns.gnn.models.allegro.Allegro`: it constructs the shared
