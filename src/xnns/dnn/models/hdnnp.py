...
featurizer for an :class:`~xnns.dnn.featurizers.AEV` and you have ANI (see
ani.py) -- the model code is identical.
"""
from __future__ import annotations

from xnns.common.models.registry import register_model
from xnns.dnn.featurizers import RadialSymmetryFunctions
...
class HDNNP(DescriptorPotential):
    ...
    :class:`~xnns.dnn.featurizers.AEV` yields ANI (see ``ani.py``).
