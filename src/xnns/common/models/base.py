...
:class:`xnns.common.models.outputs.ForceStressOutput` via autograd, so every model gets
...
class InteratomicPotential(nn.Module):
    ...
    added uniformly by
    :class:`xnns.common.models.outputs.ForceStressOutput` via autograd, so every
