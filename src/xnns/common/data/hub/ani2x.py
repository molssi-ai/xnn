...
(:meth:`xnns.dnn.models.ani.ANI.ani2x`) was trained on. Upstream distributes it
...
* Upstream energies are in **Hartree**, forces in **Hartree/angstrom**, and
  ...
  eV/angstrom (the convention used elsewhere in xnns); ``units="hartree"``
...
class ANI2xBuilder(DatasetBuilder):
    ...
    then parsed into xnns structure dicts.
    """
