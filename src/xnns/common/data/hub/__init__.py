...
Download and preprocess upstream atomistic datasets into xnns' native structure
dicts (optionally ready-to-train :class:`~xnns.common.data.dataset.AtomicDataset`
...
default; see :func:`~xnns.common.data.hub._download.default_cache_dir`. Add a new
